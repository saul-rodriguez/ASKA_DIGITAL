...
# Created by Genus(TM) Synthesis Solution 21.18-s082_1 on Mon Sep 09 08:11:40 EDT 2024
...
set_db -quiet runtime_by_stage {{PBS_Generic-Start 0 8 0.0 6.0} {to_generic 4 12 4 10} {first_condense 7 19 7 17} {PBS_Generic_Opt-Post 12 20 10.712359 16.712359} {{PBS_Generic-Postgen HBO Optimizations} 0 20 0.0 16.712359} {PBS_TechMap-Start 0 20 0.0 16.712359} {{PBS_TechMap-Premap HBO Optimizations} 0 20 0.0 16.712359} {second_condense 1 21 1 20} {reify 2 23 2 22} {global_incr_map 0 23 0 23} {{PBS_Techmap-Global Mapping} 4 24 4.153181 20.86554} {{PBS_TechMap-Datapath Postmap Operations} 0 24 0.0 20.86554} {{PBS_TechMap-Postmap HBO Optimizations} 0 24 -0.004436000000001883 20.861103999999997} {{PBS_TechMap-Postmap Clock Gating} 0 24 1.0 21.861103999999997} {{PBS_TechMap-Postmap Cleanup} 1 25 -0.0010099999999972908 21.860094} {PBS_Techmap-Post_MBCI 0 25 0.0 21.860094} {incr_opt 2 27 2 26} }
...
set_db -quiet flow_metrics_snapshot_uuid e33b3bf3-9992-4f67-b4e0-20f9885c236d
...
set_db -quiet design:aska_dig .qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 60936} {cell_count 1480} {utilization  0.00} {runtime 4 12 4 10} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 62812} {cell_count 1747} {utilization  0.00} {runtime 7 19 7 17} }{second_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 61986} {cell_count 1707} {utilization  0.00} {runtime 1 21 1 20} }{reify {wns 698} {tns 0} {vep 0} {area 51789} {cell_count 1250} {utilization  0.00} {runtime 2 23 2 22} }{global_incr_map {wns 394} {tns 0} {vep 0} {area 49776} {cell_count 1204} {utilization  0.00} {runtime 0 23 0 23} }{incr_opt {wns 214748365} {tns 0} {vep 0} {area 48862} {cell_count 1187} {utilization  0.00} {runtime 2 27 2 26} }}
...
## Written on 08:11:40 09-Sep 2024
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid e33b3bf3-9992-4f67-b4e0-20f9885c236d}
