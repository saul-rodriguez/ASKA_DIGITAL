...
# Generated on: Mon Sep 09 08:11:37 EDT 2024 (Mon Sep 09 12:11:37 UTC 2024)
...
set logfile fv/aska_dig/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/aska_dig -revised fv_map
...
read_library -liberty -both \
    /home/saul/projects/ASKA_DIGITAL/ASKA_DIG/genus2/../liberty/LIBERTY_STD_CELLS/D_CELLS_JI3V_LPMOS_MOS3LP_slow_3_00V_125C.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../src/aska_dig.v
elaborate_design -golden -root {aska_dig} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/aska_dig/fv_map.v.gz
elaborate_design -revised -root {aska_dig}
...
#add_name_alias fv/aska_dig/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.aska_dig.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.aska_dig.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.aska_dig.rtl.fv_map.rpt
